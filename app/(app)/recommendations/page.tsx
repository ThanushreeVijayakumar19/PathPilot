...
export default async function RecommendationsPage() {
  ...
  const items: MatchedInternship[] = (internships ?? []).map((i) => {
    ...
    return {
      ...
      source: (i.source as 'ai' | 'adzuna') ?? 'ai',
      applyUrl: i.apply_url ?? null,
    }
  })
  ...
  return (
    <div>
      <PageHeader
        ...
        description={
          hasResume
            ? "Real listings where available, ranked by semantic match to your actual skills — showing exactly what you have and what you're missing."
            : 'Upload and analyze your resume first so AIRA can find roles that actually fit your skills.'
        }
      />
      <RecommendationsList
        items={items}
