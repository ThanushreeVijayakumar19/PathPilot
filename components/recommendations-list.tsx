          ...
          >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="mt-0.5 flex flex-wrap items-center gap-1.5">
                    ...
                    {r.source === 'adzuna' ? (
                      <span className="flex items-center gap-1 rounded-full bg-emerald-500/10 px-1.5 py-0.5 text-[10px] font-bold uppercase tracking-wide text-emerald-700">
            ...
            <div className="mt-5 flex gap-2 border-t border-border pt-4">
              {r.applyUrl ? (
                ...
                <Button
                  disabled
                  title="This is an AI-generated practice listing, not a real posting to apply to"
